...
$(function () {
	...
	const $indicator = $('main > .slides-pagination > li > a')
	...
	$indicator.on('click', function (evt) {
		...
		//슬라이드 처리
		$container.stop().animate({ left: -1920 * nowIdx }, 1000)
	})
	...
	setInterval(function () {
		...
		$indicator.eq(nowIdx).parent().addClass('on').siblings().removeClass('on')
		$container.stop().animate({ left: -1920 * nowIdx }, 400)
	}, 3000)
})
...
//슬라이드
$(function () {
	const $slides = $('.home > .slides-container > p')
	const $indicator = $('.home > .pagination > ul > li > a')
